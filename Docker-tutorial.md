...
Note that we are using `-p 8080:8080` argument to set up port forwarding to make IPython notebook accessible at address http://localhost:8080. If you're using AWS, make sure that you've [set up the port forwarding](https://github.com/AVBelyy/natural-language-processing-colab/blob/master/AWS-tutorial.md#2-set-up-dependencies-and-run-your-project) there as well.
...
- If you're running Docker on AWS, make sure you've set up port forwarding as described [here](https://github.com/AVBelyy/natural-language-processing-colab/blob/master/AWS-tutorial.md#2-set-up-dependencies-and-run-your-project).
